...
**[v1.0.6](https://github.com/stoatworks-labs/downpour/releases/tag/v1.0.6)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`downpour-1.0.6-macos-universal.dmg`](https://github.com/stoatworks-labs/downpour/releases/download/v1.0.6/downpour-1.0.6-macos-universal.dmg) | 705 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`downpour-1.0.6-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/downpour/releases/download/v1.0.6/downpour-1.0.6-windows-x86_64-setup.exe) | 284 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .zip archive (OpenFX — Resolve, Vegas, Nuke) | [`downpour-ofx-linux-x86_64.zip`](https://github.com/stoatworks-labs/downpour/releases/latest/download/downpour-ofx-linux-x86_64.zip) | 837 KB |
