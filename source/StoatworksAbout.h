/*
 * Stoatworks Labs - About window data for Downpour.
 *
...
{
    inline constexpr auto name = "Downpour";
    inline constexpr auto slug = "downpour";
    inline constexpr auto hook = "Digital rain for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/downpour/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/downpour/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/downpour";
